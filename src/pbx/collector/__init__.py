"""
PBX-site edge collector.

Two independent readers, one per device at a PBX site:

  node_logd   the LiLyGO's Meshtastic console  -> measurement point P2
  pbx_logd  the nRF52840's VCOM              -> measurement point P1
...
Both publish to `meshtastic-testbed/<p1|p2>/pbx`, discriminated by a `kind`
